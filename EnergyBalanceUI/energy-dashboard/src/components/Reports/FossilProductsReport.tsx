...
import "../../styles/FossilProductsReport.css";
    ...
    const fetchData = async () => {
      ...
      try {
        const res = await fetch(
          `http://localhost:5244/api/energy/report/by-product-filtered?country=${selectedCountry}&year=${selectedYear}`
        );
  ...
  return (
    <div className="energy-by-product-card">
      <div className="energy-by-product-header">
        <h2>
           Zasoby kopalne - Produkcja ({selectedCountry}, {selectedYear})
        </h2>
