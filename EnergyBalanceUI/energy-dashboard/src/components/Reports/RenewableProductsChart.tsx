      ...
      for (const country of countries) {
        try {
          const res = await fetch(
            `http://localhost:5244/api/energy/report/by-renewableproduct-filtered?country=${country.code}&year=${selectedYear}`
          );
  ...
  return (
    <div className="energy-comparison-card">
      <div className="chart-controls">
        <h2> Odnawialne źródła energii - porównanie ({selectedYear})</h2>
        <Select
